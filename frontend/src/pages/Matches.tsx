  ...
  const mockMatches: Match[] = [
    {
      ...
      tournamentId: '1',
      round: 1,
      player1: { id: '1', userId: '1', name: 'John Smith', rating: 4.2, wins: 15, losses: 3, gamesPlayed: 18 },
      player2: { id: '2', userId: '2', name: 'Mike Johnson', rating: 4.0, wins: 12, losses: 6, gamesPlayed: 18 },
      status: 'scheduled',
    ...
    },
    {
      ...
      tournamentId: '1',
      round: 1,
      player1: { id: '3', userId: '3', name: 'Sarah Wilson', rating: 4.5, wins: 20, losses: 2, gamesPlayed: 22 },
      player2: { id: '4', userId: '4', name: 'Emma Davis', rating: 4.1, wins: 14, losses: 8, gamesPlayed: 22 },
      status: 'in-progress',
    ...
    },
    {
      ...
      tournamentId: '2',
      round: 1,
      player1: { id: '5', userId: '5', name: 'David Brown', rating: 3.8, wins: 10, losses: 5, gamesPlayed: 15 },
      player2: { id: '6', userId: '6', name: 'Lisa Garcia', rating: 4.3, wins: 18, losses: 4, gamesPlayed: 22 },
      status: 'completed',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track and manage tournament matches</p>
        </div>
        {user?.role === 'organizer' && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-gray-600">{mockMatches.length}</div>
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                {format(new Date(selectedMatch.startTime), 'MMM dd, yyyy • HH:mm')}
              </p>
            </div>

            <div className="space-y-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">Sets Played</span>
                <select
                  value={scoreData.setsPlayed}
                  onChange={(e) => setScoreData({ ...scoreData, setsPlayed: parseInt(e.target.value) })}
              ...
              {Array.from({ length: scoreData.setsPlayed }, (_, setIndex) => (
                <div key={setIndex} className="border border-gray-200 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-gray-700 mb-3">Set {setIndex + 1}</h4>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setScoreData({ ...scoreData, player1Games: newGames });
                        }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          newGames[setIndex] = parseInt(e.target.value) || 0;
                          setScoreData({ ...scoreData, player2Games: newGames });
                        }}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-center"
                      />
                    </div>
