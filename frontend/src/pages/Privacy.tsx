      ...
      content: [
        {
          ...
          text: 'We collect information you provide directly to us, such as when you create an account, join a tournament, or contact us for support. This includes your name, email address, phone number, and tournament preferences.'
        },
        {
          ...
          <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-green-200">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-gray-700 mb-6">
                At PicklePro, we believe in transparency and giving you control over your personal information. 
                We only collect data that helps us provide better tournament experiences and never sell your 
