  ...
  const sections = [
    {
      ...
      content: [
        {
          text: 'By accessing and using PicklePro ("the Platform"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.'
        },
        {
      ...
      content: [
        {
          ...
          text: 'The Platform, including all software, designs, text, graphics, and other content, is owned by PicklePro and protected by intellectual property laws.'
        },
        {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-4">
              These terms govern your use of PicklePro and outline the rights and 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-gradient-to-r from-blue-50 to-green-50 border-blue-200">
            <CardContent className="p-8 text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Terms Overview</h2>
              <p className="text-lg text-gray-700 mb-6">
                By using PicklePro, you agree to these terms which ensure a fair, safe, 
                and enjoyable experience for all users in our pickleball community.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <Users className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                  <h3 className="font-semibold text-gray-900">Fair Play</h3>
                  <p className="text-sm text-gray-600">Respectful community standards</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900">Legal Framework</h3>
                  <p className="text-sm text-gray-600">Clear guidelines and rules</p>
                </div>
              </div>
            </CardContent>
          </Card>
